...
internal class IndicesTestKt {
    ...
    fun sumArray(size: Int) {
        ...
        Assertions.assertEquals(BestRatingsKt.sumArray(matrix), IndicesKt.sumArray(matrix))
    }
}